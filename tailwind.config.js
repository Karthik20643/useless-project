  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        department: {
          red: "var(--color-department-red)", // red-500
          yellow: "var(--color-department-yellow)", // amber-400
          blue: "var(--color-department-blue)", // blue-600
          green: "var(--color-department-green)", // emerald-500
          purple: "var(--color-department-purple)", // violet-500
        },
        text: {
